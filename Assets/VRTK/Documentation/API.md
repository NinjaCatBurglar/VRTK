 ...
 * `public enum Headsets` - SDK Headset types.
   ...
   * `WindowsMixedReality` - A summary of all Windows Mixed Reality headset versions.
   * `AcerMixedReality` - A specific version of the WindowsMR headset, the consumer version of the Acer Mixed Reality headset.
